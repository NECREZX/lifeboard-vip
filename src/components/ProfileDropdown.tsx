  ...
  return (
    <div className="relative no-print" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 p-1 rounded-full border border-white/30 bg-white/15 hover:bg-white/25 transition select-none focus:outline-none overflow-hidden shadow-sm cursor-pointer"
        id="profile-dropdown-btn"
      >
        <div className="w-8 h-8 rounded-full overflow-hidden bg-white/15 flex items-center justify-center shadow-inner">
        ...
        <span className="text-xs font-bold text-white max-w-[80px] truncate hidden sm:inline-block pr-2">
          {profile.name}
        </span>
      </button>
      ...
      {isOpen && (
        <div 
          className="absolute right-0 mt-2 w-72 bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800/90 rounded-2xl shadow-[0_12px_40px_rgba(0,0,0,0.18)] z-[100] overflow-hidden"
          ...
          <div className="p-2 flex flex-col gap-0.5">
            ...
            <div className="flex flex-col gap-2 p-2.5">
              <div className="flex flex-col gap-1">
                ...
                <div className="flex gap-2">
                  <input 
                    ...
                    className="w-1/2 text-xs p-2 rounded-lg border bg-white text-slate-900 dark:bg-slate-800 dark:text-slate-100 border-slate-300 dark:border-slate-700 focus:outline-none focus:ring-1 focus:ring-teal-500 font-medium cursor-pointer shadow-xs" 
                  />
                  <input 
                    type="date" 
                    value={endDate} 
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 p-2.5 rounded-xl text-xs font-semibold text-white bg-rose-500 hover:bg-rose-600 transition shadow-sm"
              >
